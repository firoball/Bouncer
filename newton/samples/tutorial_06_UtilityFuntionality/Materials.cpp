...
// structures used to hold different materials interaction 
...
//	NewtonMaterialSetCollisionCallback (nWorld, woodID, woodID, &wood_wood, GenericContactBegin, GenericContactProcess, GenericContactEnd); 
	...
	NewtonMaterialSetDefaultElasticity (nWorld, woodID, woodID, 0.1f);
	...
	NewtonMaterialSetDefaultElasticity (nWorld, woodID, levelID, 0.1f);
